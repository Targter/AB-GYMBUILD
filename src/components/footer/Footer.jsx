...
import "./footer.css";
import LOGO from "../../assets/logos/ab.png";
      ...
      <div className="footer-container">
        <div className="row1">
          <div className="col1">
            <h3 className="footer-title">
              <span class="underline">Ab-Build gym</span>
            </h3>
            <ul className="footer-text">
              <li>Rajasthan</li>
              <li>416 Marion drive</li>
              <li>mon - su: 0:00 - 0:00</li>
            </ul>
          </div>
        ...
        <div className="row2">
          <div className="col3">
            ...
            <h3 className="footer-strike-title">AB-BUILD fitness</h3>
          </div>
        </div>
        ...
        <div className="row3">
          ...
          <div className="col5">
            <h3 className="footer-title">
              <span class="underline">Ab-build socials</span>
            </h3>
            <span></span>
            <ul className="footer-text">
              <a href="https://www.instagram.com/eyesmyvision/">
                <li>
