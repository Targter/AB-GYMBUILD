    ...
    <section id="hero">
        ...
        <Fade bottom triggerOnce="true">
          <div className="hero-cards">
            <div className="hero-card">
              ...
              <h2>Push yourself</h2>
              <p>because no one else is going to do it for you.</p>
            </div>
            ...
            <div className="hero-card">
              ...
              <h2>Pro team</h2>
              <p>
                Our coaches are experts in their field. Ready to help you
                achieve your goals.
              </p>
            </div>
            ...
            <div className="hero-card">
              ...
              <h2>Ladies zone</h2>
              <p>
                Your comfort is our priority. Ladies only zone in all of our
                gyms.
              </p>
            </div>
      ...
      <div className="hero-classes-container">
        <Fade bottom triggerOnce="true">
          ...
          <h2 className="h2-classes">Group classes</h2>
        </Fade>
